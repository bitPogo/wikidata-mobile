package tech.antibytes.gradle.wikidata.script
 ...
 * }
 *
 * Now just add id("tech.antibytes.gradle.wikidata.script.quality-spotless") to your rootProject build.gradle.kts plugins
 *
 * plugins {
